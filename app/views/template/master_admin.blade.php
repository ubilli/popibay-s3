  ...
  <body>
    ...
    <div class="header">
      <div class="row">
        ...
        <div class="go-down-a-bit-30 small-12 medium-12 large-6 columns">
        <div class="admin-text">
            <h3 id="admin-board" class="text-center white-color">
              Administrator dashboard
            </h3>
        </div>
        </div>
        <div class="go-down-a-bit-30 small-12 medium-12 large-1 columns">
  ...
  <div class="row">
    <div class="small-12 medium-12 large-3 columns">
      <div class="pb-dashboard-menu">
        <ul class="no-bullet">
          <li class="go-up-a-bit-20">
            <a href="/admin@dashboard">
              <h2 class="text-center"><i class="admin-dashboard-home fa fa-home"></i></h2>
            </a>
          </li>
          <hr>
          <li class="go-up-a-bit-20"><a href="/admin@allusers"><h5 id="al" class="text-left grey-color grow"> <i class="fa fa-users"></i> All users</h5></a></li>
          <li class="go-up-a-bit-20"><a href="/admin@petsellers"><h5 id="ps" class="text-left grey-color grow"> <i class="fa fa-paw"></i> Pet sellers</h5></a></li>
          <li class="go-up-a-bit-20"><a href="/admin@petbuyers"><h5 id="pb" class="text-left grey-color grow"> <i class="fa fa-money"></i> Pet buyers</h5></a></li>
          <li class="go-up-a-bit-20"><a href="/admin@petonline"><h5 id="ou" class="text-left grey-color grow"> <i class="fa fa-circle"></i> Online users </h5></a></li>
          <li class="go-up-a-bit-20"><a href="../dashboard/market"><h5 id="ap" class="text-left grey-color grow"> <i class="fa fa-shopping-cart"></i> Added pets (Market)</h5></a></li>
          <li class="go-up-a-bit-20"><a href="../dashboard/reports"><h5 id="pp" class="text-left grey-color grow"> <i class="fa fa-file-image-o"></i> Pending photos </h5></a></li>
          <li class="go-up-a-bit-20"><a href="../dashboard/reports"><h5 id="mu" class="text-left grey-color grow"> <i class="fa fa-share"></i> Message users </h5></a></li>
          <li class="go-up-a-bit-20"><a href="../dashboard/reports"><h5 id="st" class="text-left grey-color grow"> <i class="fa fa-life-ring"></i> Support ticket </h5></a></li>
        </ul>
      </div>
    </div>

    ...
    <div class="dashboard-content go-up-a-bit-20">
	    <div class="row">
	    	<div class="small-12 medium-12 large-12 columns">
	    		...
	    		<div class="nofifier-board">
                    <span class="close-notifier" title="close sponsored ad"><i class="fa fa-times fa-lg close-adboard-icon"></i></span>
                </div>
	    	</div>
	    	</div>
	    </div>
    	<div class="row">
    		...
    		<div class="small-12 medium-12 large-7 columns">
    			<div class="content-box">
    				...
    				<div class="dashboard-summary-large-box">
    					lorem
    				</div>
    			</div>
    		</div>

...
<div class="row">
  <div class="small-12 medium-12 large-12 columns">
  	<div class="post-box-content">
  		...
  		<div class="row">
            ...
            <?php
              ...
              $petad_paginate = Petad::paginate(5);
              $naira = "₦";
            ...
            <?php
            	...
            	switch ($search_term) {
                    case 'newest':
                    $search_result_newests = Petad::latest('created_at')->get();
                    $petad_alls = $search_result_newests;
                    $search_result_count = Petad::latest('created_at')->count();
	...
	<h3 class="text-center">Your search result was not found for <b>" '.$search.' "</b>.</h3>
                    ...
                    case 'oldest':
                    $search_result_newests = Petad::oldest('created_at')->get();
                    $petad_alls = $search_result_newests;
                    $search_result_count = Petad::oldest('created_at')->count();
	...
	<h3 class="text-center">Your search result was not found for <b>" '.$search.' "</b>.</h3>
                    ...
                    case 'cheapest':
                    $search_result_newests = Petad::orderBy('pet_price','asc')->get();
                    $petad_alls = $search_result_newests;
                    $search_result_count = Petad::oldest('created_at')->count();
	...
	<h3 class="text-center">Your search result was not found for <b>" '.$search.' "</b>.</h3>
            		...
            		case 'dog':
            		$search_result_newests = Petad::where('categories','=',$search_term)->get();
                    $petad_alls = $search_result_newests;
                    $search_result_count = Petad::where('categories','=',$search_term)->count();
	...
	<h3 class="text-center">Your search result was not found for <b>" '.$search.' "</b>.</h3>
            		...
            		case 'abia':
            		$search_result_newests = Petad::where('location','=',$search_term)->get();
            		$petad_alls = $search_result_newests;
            		$search_result_count = Petad::where('location','=',$search_term)->count();
...
<script>
  /* The document title */
  document.title="Popibay || Ourads || Searching...";
</script>
@stop
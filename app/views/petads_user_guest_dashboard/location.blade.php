...
<div class="row">
  ...
  <div class="category-box-location">
    ...
    <div class="states-in-nigeria-list">
      <h4 class="text-left main-dark-color-no-hover go-down-a-bit-10">Popular states</h4>
      ...
      <hr>
      <h4 class="text-left main-dark-color-no-hover go-down-a-bit-10">States in Nigeria</h4>
      <ul class="no-bullet go-down-a-bit-30">

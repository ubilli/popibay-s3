...
<head>
  ...
  <title>Welcome to Popibay | Complete your registration.</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
  <style type="text/css">
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#eee" style="border-collapse:collapse;"><tr><td>
	...
	<div style="display:none;font-size:1px;color:#222222;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide: all;">
		#1 Pet only classified ads market in Nigeria.
	</div>
  ...
  <table border="0" width="600" cellpadding="0" cellspacing="0" align="center" style="width:600px; margin: auto;" class="email-container">
    <tr>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <a href="http://www.popibay.com">
              <img src="https://www.dropbox.com/s/xcbuijsc5wxyydk/popibay_logo_main_updated_made_with_ai.png?raw=1" alt="Popibay logo" width="150" height="50" border="0" style="display: block; margin: auto;">
            </a>
            </td>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
          ...
          <!-- <tr>
            <td valign="middle" align="center">
              <img src="http://placehold.it/600x300" alt="alt text" height="300" width="600" align="center" border="0" style="margin: auto;" class="fluid">
            </td>
          </tr> -->
          ...
          <tr>
            <td style="padding: 4%; font-family: sans-serif; font-size: 18px; line-height: 1.3; color: #666666;">
              Welcome {{ $pb_username }} to Popibay.com, your number one pet only classified ads market in Nigeria. Please, kindly confirm your email by clicking the button below. 
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 4%; font-family: sans-serif; font-size: 18px; line-height: 1.3; color: #666666;">
              <center>
              	<a href="{{ URL::to('confirm/registration/' . $confirmation_code) }}" style="background: #818110;
              	border: 15px solid #818110; padding: 0 10px;color: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 1; text-align: center; text-decoration: none; display: block; border-radius: 3px;">
              	<b><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->Confirm registration<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></b>
              </a>
              </center>
            </td>
          </tr>
    ...
    <tr>
      <td style="text-align:center; padding:4% 0; font-family:sans-serif; font-size:13px; line-height:1.2; color:#666666;">
        You received this email because you registered on <a href="http://www.popibay.com">Popibay.com</a>.
        <br><br>
        Copyright  2015 Popibay.com | All rights reserved | A Jobinpal Enterprises product. &bull; <span class="mobile-link--footer">FESTAC Extension, Mile 2 Lagos Nigeria.</span> &bull; <span class="mobile-link--footer">+234(0)8160163221, +234(0)8128283993</span>
      </td>
    </tr>
    <!-- Footer : END -->
